...
Marble.Marble.prototype._updateSphere	= function()
{
	...
	var rotationX	= - 4 * speed[0] / perimeter;
	var rotationZ	= + 4 * speed[2] / perimeter;
	...
	matrix.multiplySelf(new THREE.Matrix4().setRotationZ(rotationX));
	matrix.multiplySelf(new THREE.Matrix4().setRotationX(rotationZ));
