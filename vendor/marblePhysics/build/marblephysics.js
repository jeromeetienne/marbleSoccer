 ...
 * @namespace
*/
var MarblePhysics	= {};// directly ported from https://github.com/mrdoob/MarblePhysics.js/blob/master/src/core/Vector3.js
...
};// directly ported from https://github.com/mrdoob/MarblePhysics.js/blob/master/src/core/Matrix4.js
// @author jerometienne http://jetienne.com
// - just changed the namespace
...
MarblePhysics.Matrix4 = function ( n11, n12, n13, n14, n21, n22, n23, n24, n31, n32, n33, n34, n41, n42, n43, n44 ) {
	...
	this.m33 = new MarblePhysics.Matrix3();

};

MarblePhysics.Matrix4.prototype = {

	constructor: MarblePhysics.Matrix4,
	...
	lookAt: function ( eye, center, up ) {
		...
		var x = MarblePhysics.Matrix4.__v1, y = MarblePhysics.Matrix4.__v2, z = MarblePhysics.Matrix4.__v3;
	...
	crossVector: function ( a ) {
		...
		var v = new MarblePhysics.Vector4();
	...
	clone: function () {
		...
		var m = new MarblePhysics.Matrix4();
	...
	getColumnX: function() {
		...
		if ( ! this.columnX ) {
			...
			this.columnX = new MarblePhysics.Vector3();
	...
	getColumnY: function() {
		...
		if ( ! this.columnY ) {
			...
			this.columnY = new MarblePhysics.Vector3();
	...
	getColumnZ: function() {
		...
		if ( ! this.columnZ ) {
			...
			this.columnZ = new MarblePhysics.Vector3();
	...
	compose: function ( translation, rotation, scale ) {
		...
		var mRotation = MarblePhysics.Matrix4.__m1;
		var mScale = MarblePhysics.Matrix4.__m2;
	...
	decompose: function ( translation, rotation, scale ) {
		...
		var x = MarblePhysics.Matrix4.__v1;
		var y = MarblePhysics.Matrix4.__v2;
		var z = MarblePhysics.Matrix4.__v3;

		x.set( this.n11, this.n21, this.n31 );
		y.set( this.n12, this.n22, this.n32 );
		z.set( this.n13, this.n23, this.n33 );

		translation = ( translation instanceof MarblePhysics.Vector3 ) ? translation : new MarblePhysics.Vector3();
		rotation = ( rotation instanceof MarblePhysics.Quaternion ) ? rotation : new MarblePhysics.Quaternion();
		scale = ( scale instanceof MarblePhysics.Vector3 ) ? scale : new MarblePhysics.Vector3();
		...
		var matrix = MarblePhysics.Matrix4.__m1;
...
MarblePhysics.Matrix4.makeInvert = function ( m1, m2 ) {
	...
	if ( m2 === undefined ) m2 = new MarblePhysics.Matrix4();
...
MarblePhysics.Matrix4.makeInvert3x3 = function ( m1 ) {

	// input:  MarblePhysics.Matrix4, output: MarblePhysics.Matrix3
	...
	if ( det == 0 ) {
		...
		console.error( 'MarblePhysics.Matrix4.makeInvert3x3: Matrix not invertible.' );
...
MarblePhysics.Matrix4.makeFrustum = function ( left, right, bottom, top, near, far ) {

	var m, x, y, a, b, c, d;

	m = new MarblePhysics.Matrix4();
...
MarblePhysics.Matrix4.makePerspective = function ( fov, aspect, near, far ) {
	...
	return MarblePhysics.Matrix4.makeFrustum( xmin, xmax, ymin, ymax, near, far );

};

MarblePhysics.Matrix4.makeOrtho = function ( left, right, top, bottom, near, far ) {
...
MarblePhysics.Matrix4.__v1 = new MarblePhysics.Vector3();
MarblePhysics.Matrix4.__v2 = new MarblePhysics.Vector3();
MarblePhysics.Matrix4.__v3 = new MarblePhysics.Vector3();

MarblePhysics.Matrix4.__m1 = new MarblePhysics.Matrix4();
MarblePhysics.Matrix4.__m2 = new MarblePhysics.Matrix4();/**
*/
