...
{
// NOTE: to test microphysics.js
if( true ){
	var body	= this._mesh._vphyBody;
	// TODO this function should be body.getVelocity()
	var speedX	= body.x - body.px;
	var speedY	= body.y - body.py;
	var speedZ	= body.z - body.pz;

	var perimeter	= 2 * Math.PI * this._radius;
	// FIXME why do i need this 4 ???
	var rotationZ	= - 4 * speedX / perimeter;
	var rotationX	= + 4 * speedZ / perimeter;
	//return;
}else{
	// apply friction
