...
{
	var key		= {
		left	: keyboard.pressed('A') || keyboard.pressed('J') || keyboard.pressed('Q') || keyboard.pressed('left'),
		right	: keyboard.pressed('D') || keyboard.pressed('L') || keyboard.pressed('right'),
		up	: keyboard.pressed('W') || keyboard.pressed('I') || keyboard.pressed('Z') || keyboard.pressed('up'),
